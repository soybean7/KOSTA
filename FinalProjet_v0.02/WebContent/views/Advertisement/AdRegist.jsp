...
<body>
    ...
    <!-- SIGNIN MODEL END -->
    	...
    	<!--Content Wrap Start-->
   			<form action="${ctx}/registAd.do" method="post" role="form">
				<div class="container">
					<div class="row">
						<div class="col-md-8">
                            <a class="event_link edit" type="submit">등록<i class="fa fa-edit"></i></a>
                            <a class="event_link remove" type="reset">취소<i class="fa fa-remove"></i></a>
                            <br><br>
                            <!-- BLOG PG FORM START-->
	    						<div class="blog_pg_form">
	    							...
	    							<form>
	    								<div class="col-md-3">
                                            <input type="text" placeholder="모임 ID" readonly>
                                        </div>
                                        <div class="col-md-9">
	    									<input type="text" placeholder="${meeting.meetingId}" readonly>
	    							    </div>
	    							    <div class="col-md-3">
                                            <input type="text" placeholder="모임 제목" readonly>
                                        </div>
                                        <div class="col-md-9">
	    									<input type="text" placeholder="${meeting.title}" readonly>
	    							    </div>
	    							    <div class="col-md-3">
                                            <input type="text" placeholder="광고등록자 이름" readonly>
                                        </div>
                                        <div class="col-md-9">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" placeholder="${meeting.email}" id="email">
                                        </div>
                                        <div class="col-md-3">
                                            <input type="text" placeholder="전화번호" readonly>
                                        </div>
                                        <div class="col-md-9">
                                            <input type="text" placeholder="필수입력" id="phoneNumber">
                                        </div>
                                        <div class="col-md-3">
                                            <input type="text" placeholder="광고시작일" readonly>
                                        </div>
                                        <div class="col-md-3">
                                            <input type="datetime-local" id="startDate">
                                        </div>
                                        <div class="col-md-3">
                                            <input type="text" placeholder="광고종료일" readonly>
                                        </div>
                                        <div class="col-md-3">
                                        ...
                                        <br>
                                        <div class="col-md-3">
                                            <input type="text" placeholder="요금제" readonly>
                                        </div>
                                        <div class="col-md-3">
                                            <form id="product">
											  <select name="product">
											    <option value="volvo">1주</option>
											    <option value="saab">2주</option>
											    <option value="fiat">3주</option>
											    <option value="audi">4주</option>
											  </select>
											  <br><br>
											</form>
                                        </div>
                                        <div class="col-md-12">
                                            <textarea placeholder="관리자에게 문의할 내용" id="question"></textarea>
                                        </div>
										...
										<div class="row">
											<div class="col-md-4 col-sm-4">
												<div class="kf_event_speakers_des">
													<figure><img src="${ctx}/resources/extra-images/${adList.image}" alt="No title" title="No Image" /></figure>
	                                                <p>사진1</p>
